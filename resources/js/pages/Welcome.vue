...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[url('/images/background.png')] bg-cover bg-center bg-no-repeat p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[url('/images/background-dark.jpg')]">
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        ...
                        <li>
                            <a
                                href="/CHALLENGE.md"
                                target="_blank"
                                class="inline-block rounded-sm border border-gray-300 bg-white px-5 py-1.5 text-sm leading-normal text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                            >
                                Read Instructions
                            </a>
                        </li>
                ...
                <div
                    class="relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                >
                    <img 
                        src="/images/rocketBull.png" 
                        alt="Your image description"
                        class="w-[calc(100%-2.5rem)] h-full object-cover ml-10"
                    />
                    <div
                        class="absolute inset-0 rounded-t-lg lg:overflow-hidden lg:rounded-t-none lg:rounded-r-lg"
                    />
                </div>
            </main>
        </div>
